// entregadores.js — Cadastro e listagem de entregadores
  ...
  try {
    ...
    el.innerHTML = lista.map(e => `
      <div class="list-item">
        ...
        <button class="btn btn-danger" onclick="removerEntregador(${e.id})" title="Remover entregador">
    ...
    el.innerHTML = '<div class="empty">Erro ao carregar entregadores. O servidor esta rodando?</div>';
    console.error(e);
  }
}
...
async function removerEntregador(id) {
  ...
  try {
    ...
    alert('Erro ao remover entregador: ' + e.message);
  }
}
